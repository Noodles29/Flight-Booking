...
<div class="container-fluid">
        <form action="" id="signup-frm">
            ...
            <div class="form-group">
                ...
                <input id="email-input2" class="form-control", type="email" name="name">
            </div>
            <div id="password2" class="form-group">
                <label class="control-label">Password:</label>
                <input id="password-input2", class="form-control", type="password" name="">
            </div>
            ...
            <div class="form-group">
                ...
                <input id="date-input" type="date" class="form-control" name="birthdaytime">
            </div>
            <div class="form-group">
                <label class="control-label">Phone number:</label>
                <input id="phone-input" type="tel" class="form-control" name="quantity" min="1" max="5">
            </div>
