				...
				<table class="table table-bordered" id="flight-list">
					...
					<tbody>
						<?php
							...
							$qry = $conn->query("SELECT b.*,f.*,a.airlines,a.logo_path,b.id as bid FROM  booked_flight b inner join flight_list f on f.id = b.flight_id inner join airlines_list a on f.airline_id = a.id where b.user_id = $user_id order by b.id desc");
